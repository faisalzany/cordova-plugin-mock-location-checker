    ...
    public boolean execute(String action, JSONArray data, final CallbackContext callbackContext) throws JSONException {
        if (action.equals("check")) {
            if (android.os.Build.VERSION.SDK_INT < 18) {
                ...
                //objGPS.put("listenerON",listenerON);
                //arrayGPS.put(objGPS);
                ...
                if(listenerON != true) {
                    ...
                    locationListener = new LocationListener() {
                        public void onLocationChanged(Location location) {
                            ...
                            String datetime = formatDate(dateGPS);
                             ...
                             try{
                                 ...
                                 objGPS.put("isGPSEnabled",isGPSEnabled);
                                 //objGPS.put("androidOS",android.os.Build.VERSION.SDK_INT);
                                 //objGPS.put("LOC_PROV",LOCATION_PROVIDER);
                        ...
                        public void onStatusChanged(String provider, int status, Bundle extras) {
                            // asli gak ada
                            // try{
                            //     objGPS.put("onStatusChanged",provider);
                            //     arrayGPS.put(objGPS);
                            //     callbackContext.success(arrayGPS);
                            // } catch (JSONException e) {
                            //     e.printStackTrace();
                        ...
                        public void onProviderEnabled(String provider) {
                            // asli gak ada
                            // try{
                            //     objGPS.put("onProviderEnabled",provider);
                            //     arrayGPS.put(objGPS);
                            //     callbackContext.success(arrayGPS);
                            // } catch (JSONException e) {
                            //     e.printStackTrace();
                        ...
                        public void onProviderDisabled(String provider) {
                            // asli gak ada
                            // try{
                            //     objGPS.put("onProviderDisabled",provider);
                            //     arrayGPS.put(objGPS);
                            //     callbackContext.success(arrayGPS);
                            // } catch (JSONException e) {
                            //     e.printStackTrace();
